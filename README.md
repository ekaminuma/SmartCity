...
　　　 - エンジニア、建築家、建設業者、都市計画者が包括的な都市規模のデジタルツイン内で作業できるように
  ...
  - 2019/9/24 [都市がデジタルツインから恩恵を受ける7つの方法](https://www.gim-international.com/case-study/seven-ways-cities-benefit-from-digital-twins) 
     ...
     -  3.大規模なイベントを開催する場合でも、公共スペースの移動性と安全性を向上させる=エンジニアと設計者は、デジタルツインを使用して、設計と運用および商業計画を正確にテストし、足跡、経路探索、群集管理、安全性、およびセキュリティを強化できます。
     -  4. 都市計画とプロジェクトの可視化を改善する＝都市計画担当者は大規模なデジタルツインをオンラインでストリーミングし、地形モデル、リアリティメッシュ、セマンティック3D都市モデルの組み合わせを使用して都市全体から街路レベルまでのプロジェクトを可視化。インテリジェントモデルが個々の建物に関連付けられている場合、都市計画担当者はこれらのモデルを都市全体のデジタルツインにマージして、都市に関する情報をさらにインテリジェントにすることができます。例：LEGIONを使用して群集シミュレーションを実行し、OpenCities Plannerを使用して、市内のイベントのために集まる群集を可視化。関心のあるポイントは、最寄りの地下鉄の入り口やエリアからの出口と組み合わされる。
     -  5.インフラストラクチャの回復力を高める：急性ショックを予測し、対応し、回復＝地震の影響も大きく、人命の損失や建物や交通インフラ、地下への被害などが含まれる可能性があります。デジタルツインは、計画と対応の利害関係者に、安全な距離からの損傷を視覚化、分析、測定、および評価するためのプラットフォームを提供すると同時に、回復と適切な出口ルートに使用できる戦術を特定。
     -  6. 一般の人々と交流し、フィードバックループを作成します=デジタルツインテクノロジーにより、都市計画担当者は、住民からの賛同を得て投資家を引き付けるために、インタラクティブな方法で都市プロジェクトをうまく伝達、促進、共有するための迅速、簡単、視覚的な方法を提供できます。この共有には、デジタルエクスペリエンス（複合現実とウェアラブル）の提供、またはWeb、モバイル、タッチスクリーン、デジタル看板などのデバイスを介した視覚化とクラウドソーシングが含まれます。
     -  7. オープンデータイニシアチブを採用–信頼できる都市とインフラストラクチャの情報を使用して、他の人がサービスを考案、開発=デジタル都市イニシアチブを持つ多くの都市は、オープンデータ環境に焦点を合わせています。また、多くの人が大学、研究者、その他の開発者と協力して、オープンデータイニシアチブを通じて市民にアプリやサービスを提供。
