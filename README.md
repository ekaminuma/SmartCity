...
- Articles
   ...
   　　　-　最近AI / ML機能が高度予測モデリングを仮想的に「ストレステスト」インフラストラクチャに組み込むために検討されている 　
   　　　-　GISとBIMの統合
   　- 高度なセンサー, 人工知能（AI）,モノのインターネット（IoT）の採用によるインダストリー4.0の出現により、デジタルツインソリューションが拡張　
   　- デジタルツインは、機器、プロセス、ワークフロー情報、および物理資産のデジタルデータの仮想表現に対応 
   　- 複数のセンサーから抽出され、リアルタイムで同期
